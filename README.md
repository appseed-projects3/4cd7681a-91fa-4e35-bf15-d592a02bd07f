...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-31 22:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4cd7681a-91fa-4e35-bf15-d592a02bd07f.git
$ cd 4cd7681a-91fa-4e35-bf15-d592a02bd07f
```
